...
class WithCharEmbedding(nn.Module):
    ...
    def __init__(self, word_vectors, char_vectors, hidden_size, drop_prob):
        super(WithCharEmbedding, self).__init__()
        self.drop_prob = drop_prob
    ...
    def forward(self, w_idxs,c_idxs):
        word_emb=self.word_embed(w_idxs)
        char_emb=self.char_embed(c_idxs)
...
class RNNEncoder(nn.Module):
    ...
    def forward(self, x, lengths):
        ...
        # Apply RNN
        self.rnn.flatten_parameters() # Fix chunk of memory error
...
class RNNEncoder2(nn.Module):
    ...
    def __init__(self,
        ...
        self.drop_prob = drop_prob
        self.multi_h_att=nn.MultiheadAttention(input_size,4)
        self.rnn = nn.LSTM(input_size, hidden_size, num_layers,
                           batch_first=True,
                           bidirectional=True,
                           dropout=drop_prob if num_layers > 1 else 0.)
